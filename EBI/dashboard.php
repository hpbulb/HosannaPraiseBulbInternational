...
<body class="bg-white">
    ...
    <aside id="default-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-hidden  bg-gray-50">
            <div class="flex gap-2 text-blue-800 items-center text-lg p-2 mb-10">
    ...
    <div class="grid lg:grid-cols-4 px-4 py-6 lg:ml-44 md:ml-33 sm:ml-43  gap-4">
        ...
        <div class="bg-white p-5 rounded-lg shadow-md">
            <div class="flex items-center gap-2 text-green-700">
                ...
                <div class="text-gray-800 ">
                    ...
                    <p class="text-3xl mt-2 mb-2 font-bold text-green-500">3</p><span class="text-sm font-semibold">Due
        ...
        <div class="bg-white p-5 rounded-lg shadow-md">
            <div class="flex items-center gap-2 text-indigo-500">
                <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" viewBox="0 0 24 24" class=" bg-indigo-100 p-3 rounded">
    ...
    <div class="grid lg:grid-cols-3 px-6 py-10 lg:ml-44 md:ml-33 sm:ml-43  gap-4">
        ...
        <div class="bg-white p-2 rounded-lg shadow-md">
            ...
            <div class="bg-white p-4 rounded-md shadow flex items-center gap-3">
            ...
            <div class="bg-white p-4 rounded-md shadow flex items-center gap-3 mt-2">
